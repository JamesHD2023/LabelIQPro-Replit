    ...
    experts: {
      allergist: {
        name: {
          ...
          fr: 'Assistant Allergologue IA',
          es: 'Asistente Alergólogo IA',
          pt: 'Assistente Alergologista IA',
          nl: 'AI Allergie Assistent',
          no: 'AI Allergiassistent',
          sv: 'AI Allergiassistent'
        },
        title: {
          en: 'Allergy & Immunology AI',
          de: 'Allergie & Immunologie KI',
          ...
          no: 'AI Allergi & Immunologi',
          sv: 'AI Allergi & Immunologi'
        }
      },
      dermatologist: {
        name: {
      ...
      endocrinologist: {
        name: {
          ...
          es: 'Especialista Salud Metabólica IA',
          pt: 'Especialista Saúde Metabólica IA',
          nl: 'AI Stofwisseling Specialist',
          no: 'AI Metabolsk helse-spesialist',
          sv: 'AI Metabol hälsa-specialist'
        },
        title: {
          en: 'Hormone & Metabolism AI',
          de: 'Hormon & Stoffwechsel KI',
          ...
          no: 'AI Hormon & Metabolisme',
          sv: 'AI Hormon & Metabolism'
        }
      },
      toxicologist: {
        name: {
          ...
          sv: 'AI Kemisk säkerhet-analytiker'
        },
        title: {
          en: 'Toxicology AI',
          de: 'Toxikologie KI',
      ...
      nutritionist: {
        name: {
          en: 'AI Nutrition Advisor',
          de: 'KI-Ernährungs-Berater',
          fr: 'Conseiller Nutrition IA',
          es: 'Asesor Nutrición IA',
          pt: 'Consultor Nutrição IA',
          nl: 'AI Voeding Adviseur',
          no: 'AI Ernærings-rådgiver',
          sv: 'AI Närings-rådgivare'
        },
        title: {
          en: 'Digital Nutritionist',
          de: 'Digital-Ernährungswissenschaftler',
          fr: 'Nutritionniste Numérique',
          es: 'Nutricionista Digital',
          pt: 'Nutricionista Digital',
          nl: 'Digitale Voedingsdeskundige',
          no: 'Digital ernæringsfysiolog',
          sv: 'Digital nutritionist'
        }
      },
      pediatrician: {
        name: {
          en: 'AI Child Health Specialist',
          de: 'KI-Kindergesundheits-Spezialist',
          fr: 'Spécialiste Santé Enfant IA',
          es: 'Especialista Salud Infantil IA',
          pt: 'Especialista Saúde Infantil IA',
        ...
        title: {
          ...
          no: 'AI Pediatrisk sikkerhet',
          sv: 'AI Pediatrisk säkerhet'
        }
      }
    }
  }
